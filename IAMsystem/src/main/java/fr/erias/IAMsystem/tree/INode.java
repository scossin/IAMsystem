...
public interface INode {
	 ...
	 * @return the parentNode: the (i-1)th node or the rootNode if this node stores the first token of a term
	 */
	...
	/**
	 * Check if, from this node, a transition is possible to another node. 
	 * Each node is a state in a final-state automata. 
	 * A transition is possible iff the token is a path from this state to a leaf of a trie

...
/**
 * An interface to combine a tokenizer and stopwords. 
 * Theses two classes must be used together to remove stopwords.
 * 
...
public interface ITokenizerStopwords extends ITokenizer, IStopwords
{
	 ...
	 * Tokenize the text, remove stopwords.
	 * @param text a document / keyword.
	 * @param tokstop a {@link ITokenizerStopwords} instance to tokenize and detect stopwords.
	 * @return A sequence of {@link IToken} without stopwords. 
	 */

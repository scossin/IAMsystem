...
public class FrenchStemmer implements INormalizeF
{
	 ...
	 * third letter, otherwise the region after the first vowel not at the beginning
	 * of the word, or the end of the word if these positions cannot be found."
	 */
	private String RV;

	/**
	 * Region R1 "R1 is the region after the first non-vowel following a vowel or is
	 * the null region at the end of the word if there is no such non-vowel"
	 */
	private String R1;

	/**
	 * Region R2 "R2 is the region after the first non-vowel in R1 following a vowel
	 ...
	 * @param prefix  java.lang.String - the prefix to add to the search string to
	 *                test
	 ...
	 * or replace it with the replace string if preceded by the prefix in the zone
	 * "from"<br>
	 ...
	 * @param from   java.lang.String - the secondary source zone for search (where
	 *               vowel could be)
	 * @return boolean - true if modified
	 */
	 ...
	 * Will be performed if nothing changed from the first step or changed were done
	 * in the amment, emment, ments or ment suffixes<br>
	 * refer to http://snowball.sourceforge.net/french/stemmer.html for an
	 * explanation
	 *
	...
	{
		String[] search = { "îmes", "îtes", "iraIent", "irait", "irais", "irai", "iras", "ira", "irent", "iriez",
				"irez", "irions", "irons", "iront", "issaIent", "issais", "issantes", "issante", "issants", "issant",
				"issait", "issais", "issions", "issons", "issiez", "issez", "issent", "isses", "isse", "ir", "is", "ît",
				"it", "ies", "ie", "i" };
	...
	private void step2b()
	{
		String[] suffix = { "eraIent", "erais", "erait", "erai", "eras", "erions", "eriez", "erons", "eront", "erez",
				"èrent", "era", "ées", "iez", "ée", "és", "er", "ez", "é" };
		deleteFrom(RV, suffix);

		String[] search = { "assions", "assiez", "assent", "asses", "asse", "aIent", "antes", "aIent", "Aient", "ante",
				"âmes", "âtes", "ants", "ant", "ait", "aît", "ais", "Ait", "Aît", "Ais", "ât", "as", "ai", "Ai", "a" };

...
class MatcherTest {
  ...
  void testAddKeywordsArray() {
    this.matcher.addKeyword(
        new String[] {"Insuffisance Cardiaque", "Insuffisance Cardiaque Gauche"});
    assertEquals(this.matcher.getKeywords().size(), 2);
  }
  ...
  void testAnnotStopwords() {
    ...
    assertEquals(
        ann.toString(), "insuffisance cardiaque	0 12;16 25	Insuffisance Cardiaque (I50.9)");
  }
}

...
class MatcherTest
{
	...
	void testExactMatchCustomKeyword() {
		...
		MyKeyword ent1 = new MyKeyword("acute respiratory distress syndrome", "disease",
				"wikipedia", "https://www.wikidata.org/wiki/Q344873");
		Entity ent2 = new Entity("diarrrhea", "R19.7");
		...
		assertEquals(2, annots.size());
		assertEquals(annots.get(0).toString(), "acute respiratory distress syndrome	7 42	https://www.wikidata.org/wiki/Q344873");
	}
